...
// class _ChatListNewState extends State<ChatListNew> with SingleTickerProviderStateMixin {
...
//   @override
//   void didUpdateWidget(covariant ChatListNew oldWidget) {
...
//                     (widget.useTopSafeAreaInset ? MediaQuery.of(context).padding.top : 0),
//               ),
//               sliver: SliverToBoxAdapter(
