...
import 'package:flutter_chat_ui/src/models/code_theme.dart';
...
List<String?> get themeList {
  ...
  return <String?>[
    ...top,
    null, // Divider.
    ...CODE_THEMES.keys.where((el) => !top.contains(el))
  ];
}
...
class _InnerFieldState extends State<InnerField> {
  ...
  @override
  Widget build(BuildContext context) {
    final styles = CODE_THEMES[widget.theme];
  ...
  Widget _buildCodeField() => CodeField(
        lineNumbers: false,
        readOnly: true,
